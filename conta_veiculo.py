...
pos_linha = 157  # Posição da linha de contagem
...
carros = caminhoes = 0
cap = cv2.VideoCapture('https://cameras.santoandre.sp.gov.br/coi04/ID_587')
...
while True:
    ...
    # r = cv2.selectROI("select the area", frame1, fromCenter=False)
    ...
    cv2.line(frame1, (157, 158), (1, 157), (255, 127, 0), 3)
